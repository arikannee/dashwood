...
//         <div className="container lg text-gray-600 flex text-sm font-medium flex-col  sm:flex-row leading-7 sm:leading-5">
//           <div className="flex-auto flex items-center justify-center gap-1">
//             <MdLocationPin />
